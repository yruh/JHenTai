...
Пример 2: Блокировать комментарии с оценкой не выше 10 -> Комментарий Оценка <= 10
    ''',
      ...
      'refreshAiXp': 'Обновить XP',
      'aiXpEmpty': 'XP-профиля пока нет. Обновите, чтобы построить его по избранному.',
      ...
      'aiModel': 'Модель',
      'aiApiKey': 'API-ключ',
      'remoteAiDataNotice': 'Удалённый ИИ может отправлять данные профиля и запроса на настроенный эндпоинт',
      'aiSettingsSaved': 'Настройки ИИ сохранены',
      'aiNotConfigured': 'Удалённый ИИ не настроен',
      'localAiMode': 'Локальный ИИ',
      ...
      'aiRemoteFallback': 'Удалённый ИИ недоступен, переключено на локальный режим',
    };
  }
}
