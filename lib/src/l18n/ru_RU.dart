...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      'onlyShowGalleriesWithoutTorrents': 'Показывать только галереи без торрентов',
      'hideFavoritedGalleries': 'Скрыть галереи из избранного',
      'filterGalleriesByTorrentsFailed': 'Не удалось отфильтровать галереи по торрентам',
      ...
      'favoriteBatchOperations': 'Пакетные операции с избранным',
      'batchFetchFavoriteTorrents': 'Пакетно получить торренты избранного',
      'deduplicateFavorites': 'Удалить дубликаты избранного',
      'loadingAllFavorites': 'Загрузка всего избранного',
      'checkingFavoriteTorrents': 'Проверка торрентов избранного',
      'fetchingFavoriteTorrents': 'Получение торрентов избранного',
      'noFavoriteTorrentsFound': 'Торренты избранного не найдены',
      'favoriteTorrentsCopied': 'Скопировано @torrentCount торрентов из @galleryCount галерей, ошибок: @failedCount',
      'favoriteTorrentsUnavailable': 'Нет доступных для копирования торрентов; проверка не удалась у @failedCount галерей',
      'noDuplicateFavoritesFound': 'Дубликаты избранного не найдены',
      'confirmDeduplicateFavorites': 'Подтвердить удаление дубликатов избранного',
      'confirmDeduplicateFavoritesContent': 'Найдено @duplicateCount дубликатов (та же категория и нормализованный заголовок). Оставить первый, удалить остальные?',
      'deduplicateFavoritesCompleted': 'Удаление дубликатов завершено: успешно @successCount, с ошибкой @failedCount',
      'favoriteBatchOperationFailed': 'Пакетная операция с избранным не удалась',
...
Пример 2: Блокировать комментарии с оценкой не выше 10 -> Комментарий Оценка <= 10
    ''',
      ...
      'aiCenter': 'ИИ-центр',
      'aiXpTab': 'XP-профиль',
      'aiRecommendTab': 'Рекомендации',
      'aiManageTab': 'Управление',
      'aiSearchTab': 'Поиск',
      'aiXpProfile': 'ИИ XP-профиль',
      'refreshAiXp': 'Синхронизировать избранное и проанализировать',
      'aiXpEmpty': 'Настройте API ИИ и синхронизируйте избранное, чтобы создать профиль.',
      'aiXpSourceCount': 'На основе @count избранных',
      'aiXpUpdatedAt': 'Обновлено: @time',
      'aiProfileSummary': 'Сводка профиля',
      'aiPreferenceThemes': 'Темы предпочтений',
      'aiRecommendedSearches': 'Рекомендуемые направления поиска',
      'aiAdvancedStats': 'Статистика доказательств',
      'aiFavoriteCacheStatus': 'Общий кэш избранного: @count, синхронизация @time',
      'aiGeneratedRemotely': 'Создано настроенным удалённым ИИ',
      'aiEvidenceTags': 'Подтверждающие теги',
      'aiConfigureApiAction': 'Настроить API',
      'aiLocalStatsNotice': 'Локальная статистика лишь готовит данные; сводка и решения выше получены от удалённого ИИ.',
      'aiTopTags': 'Топ тегов',
      'aiTitlePreferences': 'Предпочтения по названию',
      'aiTagPairs': 'Пары тегов',
      'aiSaturatedTags': 'Насыщенные теги',
      'aiProfileBuilt': 'XP-профиль построен',
      'aiRecommendations': 'ИИ-рекомендации',
      'generateAiRecommendations': 'Сгенерировать рекомендации',
      'noAiRecommendations': 'Рекомендаций пока нет',
      'aiRecommendationScore': 'Оценка: @score',
      'aiRecommendationReasons': 'Причины',
      'aiFavoriteOrganizer': 'Организатор избранного',
      'organizationRequirement': 'Сначала постройте XP-профиль, чтобы организовать избранное',
      'previewOrganization': 'Предпросмотр организации',
      'noOrganizationRules': 'Нет подходящих правил организации',
      'noOrganizationChanges': 'Изменения не требуются',
      'organizationPreviewTitle': 'Предпросмотр организации',
      'organizationMoveLabel': 'Переместить «@title» из @from в @to',
      'applySelectedMoves': 'Применить выбранные перемещения',
      'organizationApplied': 'Организация применена: успешно @success, с ошибкой @failed',
      'scanAiDuplicates': 'Сканировать дубликаты',
      'duplicatePreviewTitle': 'Предпросмотр дубликатов',
      'duplicateGroupLabel': '@title (@count)',
      'duplicateKeeper': 'Оставить',
      'duplicateRemove': 'Удалить',
      'noAiDuplicates': 'Дубликаты не найдены',
      'duplicatesRemoved': 'Дубликаты удалены: успешно @success, с ошибкой @failed',
      'enhancedAiSearch': 'Расширенный ИИ-поиск',
      'aiSearchRequirement': 'Сначала постройте XP-профиль, чтобы использовать расширенный поиск',
      'runEnhancedSearch': 'Поиск',
      'aiSettings': 'Настройки ИИ',
      'enableRemoteAi': 'Включить удалённый ИИ',
      'aiEndpoint': 'API-эндпоинт',
      'aiModel': 'Модель',
      'aiApiKey': 'API-ключ',
      'remoteAiDataNotice': 'Компактная статистика избранного и метаданные кандидатов могут отправляться на настроенный эндпоинт',
      'aiSettingsSaved': 'Настройки ИИ сохранены',
      'aiNotConfigured': 'API ИИ не настроен',
      'localAiMode': 'Локальная статистика',
      'remoteAiMode': 'Удалённый ИИ',
      'aiLoadingFavorites': 'Загрузка избранного (@count)',
      'aiLoadingMetadata': 'Загрузка метаданных (@current/@total)',
      'aiBuildingProfile': 'Построение XP-профиля…',
      'aiFetchingCandidates': 'Получение кандидатов (@current/@total)',
      'aiScoringCandidates': 'Оценка кандидатов…',
      'aiAnalyzingOrganization': 'Анализ организации…',
      'aiApplyingOrganization': 'Применение организации (@current/@total)',
      'aiScanningDuplicates': 'Сканирование дубликатов…',
      'aiRemovingDuplicates': 'Удаление дубликатов (@current/@total)',
      'aiInterpretingSearch': 'Интерпретация поиска…',
      'aiOperationFailed': 'Операция ИИ не удалась',
      'aiNeedProfile': 'Сначала постройте XP-профиль',
      'aiSelectAtLeastOne': 'Выберите хотя бы один элемент',
      'aiRemoteFallback': 'Сбой запроса к удалённому ИИ',
    };
  }
}
