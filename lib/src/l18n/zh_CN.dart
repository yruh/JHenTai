...
favnote：匹配收藏备注
    ...
    ''',
      ...
      'aiManageTab': '管理',
      'aiSearchTab': '搜索',
      'aiXpProfile': 'AI XP 画像',
      'refreshAiXp': '重新同步收藏并分析',
      'aiXpEmpty': '请先配置 AI API，再同步收藏以生成画像',
      'aiXpSourceCount': '基于 @count 个收藏',
      'aiXpUpdatedAt': '更新于 @time',
      'aiProfileSummary': '画像摘要',
      'aiPreferenceThemes': '偏好主题',
      'aiRecommendedSearches': '推荐搜索方向',
      'aiAdvancedStats': '证据统计',
      'aiFavoriteCacheStatus': '共享收藏缓存：@count 本，同步于 @time',
      'aiGeneratedRemotely': '由已配置的远程 AI 生成',
      'aiEvidenceTags': '依据标签',
      'aiConfigureApiAction': '配置 API',
      'aiLocalStatsNotice': '本地统计只负责整理证据；上方摘要与判断均来自远程 AI。',
      'aiTopTags': '热门标签',
      'aiTitlePreferences': '标题偏好',
      'aiTagPairs': '标签组合',
      'aiSaturatedTags': '饱和标签',
      'aiProfileBuilt': 'XP 画像已构建',
      'aiRecommendations': 'AI 推荐',
      'generateAiRecommendations': '生成推荐',
      'noAiRecommendations': '暂无推荐',
      'aiRecommendationScore': '评分：@score',
      'aiRecommendationReasons': '推荐理由',
      'aiFavoriteOrganizer': '收藏整理',
      'organizationRequirement': '请先构建 XP 画像后再整理收藏',
      'previewOrganization': '预览整理',
      'noOrganizationRules': '没有匹配的整理规则',
      'noOrganizationChanges': '无需变更',
      'organizationPreviewTitle': '整理预览',
      'organizationMoveLabel': '将「@title」从 @from 移至 @to',
      'applySelectedMoves': '应用所选移动',
      'organizationApplied': '整理完成：成功 @success 个，失败 @failed 个',
      'scanAiDuplicates': '扫描重复',
      'duplicatePreviewTitle': '重复预览',
      'duplicateGroupLabel': '@title（@count）',
      'duplicateKeeper': '保留',
      'duplicateRemove': '移除',
      'noAiDuplicates': '未发现重复',
      'duplicatesRemoved': '重复移除完成：成功 @success 个，失败 @failed 个',
      'enhancedAiSearch': '增强 AI 搜索',
      'aiSearchRequirement': '请先构建 XP 画像后再使用增强搜索',
      'runEnhancedSearch': '搜索',
      'aiSettings': 'AI 设置',
      'enableRemoteAi': '启用远程 AI',
      'aiEndpoint': 'API 端点',
      'aiModel': '模型',
      'aiApiKey': 'API 密钥',
      'remoteAiDataNotice': '收藏的精简统计和候选漫画元数据可能会发送至所配置的端点',
      'aiSettingsSaved': 'AI 设置已保存',
      'aiNotConfigured': 'AI API 尚未配置',
      'localAiMode': '本地统计',
      'remoteAiMode': '远程 AI',
      'aiLoadingFavorites': '正在加载收藏（@count）',
      'aiLoadingMetadata': '正在加载元数据（@current/@total）',
      'aiBuildingProfile': '正在构建 XP 画像…',
      'aiFetchingCandidates': '正在获取候选（@current/@total）',
      'aiScoringCandidates': '正在评分候选…',
      'aiAnalyzingOrganization': '正在分析整理方案…',
      'aiApplyingOrganization': '正在应用整理（@current/@total）',
      'aiScanningDuplicates': '正在扫描重复…',
      'aiRemovingDuplicates': '正在移除重复（@current/@total）',
      'aiInterpretingSearch': '正在解析搜索…',
      'aiOperationFailed': 'AI 操作失败',
      'aiNeedProfile': '请先构建 XP 画像',
      'aiSelectAtLeastOne': '请至少选择一项',
      'aiRemoteFallback': '远程 AI 请求失败',
    };
  }
}
