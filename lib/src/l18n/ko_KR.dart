...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'refreshAiXp': 'XP 새로고침',
      'aiXpEmpty': 'XP 프로필이 없습니다. 새로고침하여 즐겨찾기 기반으로 생성하세요.',
      ...
      'aiModel': '모델',
      'aiApiKey': 'API 키',
      'remoteAiDataNotice': '원격 AI는 프로필 및 검색 데이터를 설정된 엔드포인트로 전송할 수 있습니다',
      'aiSettingsSaved': 'AI 설정이 저장되었습니다',
      'aiNotConfigured': '원격 AI가 구성되지 않았습니다',
      'localAiMode': '로컬 AI',
      'remoteAiMode': '원격 AI',
      ...
      'aiRemoteFallback': '원격 AI를 사용할 수 없어 로컬 모드로 전환했습니다',
    };
  }
}
