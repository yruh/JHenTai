...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      'onlyShowGalleriesWithoutTorrents': '토렌트가 없는 갤러리만 보기',
      'hideFavoritedGalleries': '즐겨찾기한 갤러리 숨기기',
      'filterGalleriesByTorrentsFailed': '토렌트로 갤러리 필터링 실패',
      ...
      'favoriteBatchOperations': '즐겨찾기 일괄 작업',
      'batchFetchFavoriteTorrents': '즐겨찾기 토렌트 일괄 가져오기',
      'deduplicateFavorites': '즐겨찾기 중복 제거',
      'loadingAllFavorites': '전체 즐겨찾기 불러오는 중',
      'checkingFavoriteTorrents': '즐겨찾기 토렌트 확인 중',
      'fetchingFavoriteTorrents': '즐겨찾기 토렌트 가져오는 중',
      'noFavoriteTorrentsFound': '즐겨찾기 토렌트를 찾을 수 없음',
      'favoriteTorrentsCopied': '@galleryCount개 갤러리의 토렌트 @torrentCount개를 복사했습니다, 실패: @failedCount',
      'favoriteTorrentsUnavailable': '복사할 토렌트를 얻지 못했습니다. 검사 실패 갤러리: @failedCount',
      'noDuplicateFavoritesFound': '중복된 즐겨찾기를 찾을 수 없음',
      'confirmDeduplicateFavorites': '즐겨찾기 중복 제거 확인',
      'confirmDeduplicateFavoritesContent': '중복 @duplicateCount개 발견(같은 카테고리·정규화 제목). 첫 항목만 남기고 나머지를 제거할까요?',
      'deduplicateFavoritesCompleted': '중복 제거 완료: 성공 @successCount개, 실패 @failedCount개',
      'favoriteBatchOperationFailed': '즐겨찾기 일괄 작업 실패',
      'operationCancelled': '작업이 취소됨',
...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'aiManageTab': '관리',
      'aiSearchTab': '검색',
      'aiXpProfile': 'AI XP 프로필',
      'refreshAiXp': '즐겨찾기 다시 동기화 및 분석',
      'aiXpEmpty': 'AI API를 설정한 뒤 즐겨찾기를 동기화하여 프로필을 생성하세요.',
      'aiXpSourceCount': '@count개 즐겨찾기 기반',
      'aiXpUpdatedAt': '@time에 업데이트됨',
      'aiProfileSummary': '프로필 요약',
      'aiPreferenceThemes': '선호 테마',
      'aiRecommendedSearches': '추천 검색 방향',
      'aiAdvancedStats': '근거 통계',
      'aiFavoriteCacheStatus': '공유 즐겨찾기 캐시: @count개, @time 동기화',
      'aiGeneratedRemotely': '설정된 원격 AI가 생성함',
      'aiEvidenceTags': '근거 태그',
      'aiConfigureApiAction': 'API 설정',
      'aiLocalStatsNotice': '로컬 통계는 근거만 준비하며, 위 요약과 판단은 원격 AI에서 생성됩니다.',
      'aiTopTags': '인기 태그',
      'aiTitlePreferences': '제목 선호도',
      'aiTagPairs': '태그 조합',
      'aiSaturatedTags': '포화 태그',
      'aiProfileBuilt': 'XP 프로필이 생성되었습니다',
      'aiRecommendations': 'AI 추천',
      'generateAiRecommendations': '추천 생성',
      'noAiRecommendations': '추천이 아직 없습니다',
      'aiRecommendationScore': '점수: @score',
      'aiRecommendationReasons': '추천 이유',
      'aiFavoriteOrganizer': '즐겨찾기 정리',
      'organizationRequirement': '즐겨찾기를 정리하려면 먼저 XP 프로필을 생성하세요',
      'previewOrganization': '정리 미리보기',
      'noOrganizationRules': '일치하는 정리 규칙이 없습니다',
      'noOrganizationChanges': '변경할 항목이 없습니다',
      'organizationPreviewTitle': '정리 미리보기',
      'organizationMoveLabel': '"@title"을(를) @from에서 @to(으)로 이동',
      'applySelectedMoves': '선택한 이동 적용',
      'organizationApplied': '정리 완료: 성공 @success개, 실패 @failed개',
      'scanAiDuplicates': '중복 스캔',
      'duplicatePreviewTitle': '중복 미리보기',
      'duplicateGroupLabel': '@title (@count)',
      'duplicateKeeper': '유지',
      'duplicateRemove': '제거',
      'noAiDuplicates': '중복을 찾지 못했습니다',
      'duplicatesRemoved': '중복 제거 완료: 성공 @success개, 실패 @failed개',
      'enhancedAiSearch': '강화 AI 검색',
      'aiSearchRequirement': '강화 검색을 사용하려면 먼저 XP 프로필을 생성하세요',
      'runEnhancedSearch': '검색',
      'aiSettings': 'AI 설정',
      'enableRemoteAi': '원격 AI 사용',
      'aiEndpoint': 'API 엔드포인트',
      'aiModel': '모델',
      'aiApiKey': 'API 키',
      'remoteAiDataNotice': '간소화된 즐겨찾기 통계와 후보 메타데이터가 설정된 엔드포인트로 전송될 수 있습니다',
      'aiSettingsSaved': 'AI 설정이 저장되었습니다',
      'aiNotConfigured': 'AI API가 설정되지 않았습니다',
      'localAiMode': '로컬 통계',
      'remoteAiMode': '원격 AI',
      'aiLoadingFavorites': '즐겨찾기 불러오는 중 (@count)',
      'aiLoadingMetadata': '메타데이터 불러오는 중 (@current/@total)',
      'aiBuildingProfile': 'XP 프로필 생성 중…',
      'aiFetchingCandidates': '후보 가져오는 중 (@current/@total)',
      'aiScoringCandidates': '후보 점수 산정 중…',
      'aiAnalyzingOrganization': '정리 분석 중…',
      'aiApplyingOrganization': '정리 적용 중 (@current/@total)',
      'aiScanningDuplicates': '중복 스캔 중…',
      'aiRemovingDuplicates': '중복 제거 중 (@current/@total)',
      'aiInterpretingSearch': '검색 해석 중…',
      'aiOperationFailed': 'AI 작업 실패',
      'aiNeedProfile': '먼저 XP 프로필을 생성하세요',
      'aiSelectAtLeastOne': '하나 이상 선택하세요',
      'aiRemoteFallback': '원격 AI 요청에 실패했습니다',
    };
  }
}
