...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'refreshAiXp': 'Refresh XP',
      'aiXpEmpty': 'No XP profile yet. Refresh to build one from your favorites.',
      ...
      'aiModel': 'Model',
      'aiApiKey': 'API Key',
      'remoteAiDataNotice': 'Remote AI may send profile and query data to the configured endpoint',
      'aiSettingsSaved': 'AI settings saved',
      'aiNotConfigured': 'Remote AI is not configured',
      'localAiMode': 'Local AI',
      ...
      'aiRemoteFallback': 'Remote AI unavailable, fell back to local mode',
    };
  }
}
