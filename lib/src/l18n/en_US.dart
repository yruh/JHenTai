...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'onlyShowGalleriesWithoutTorrents': 'Only Show Galleries Without Torrents',
      'hideFavoritedGalleries': 'Hide Favorited Galleries',
      'filterGalleriesByTorrentsFailed': 'Filter Galleries By Torrents Failed',
      ...
      'favoriteBatchOperations': 'Favorite Batch Operations',
      'batchFetchFavoriteTorrents': 'Batch Fetch Favorite Torrents',
      'deduplicateFavorites': 'Deduplicate Favorites',
      'loadingAllFavorites': 'Loading All Favorites',
      'checkingFavoriteTorrents': 'Checking Favorite Torrents',
      'fetchingFavoriteTorrents': 'Fetching Favorite Torrents',
      'noFavoriteTorrentsFound': 'No Favorite Torrents Found',
      'favoriteTorrentsCopied': 'Copied @torrentCount torrents from @galleryCount galleries, failed: @failedCount',
      'favoriteTorrentsUnavailable': 'No copyable torrents obtained; @failedCount galleries failed to check',
      'noDuplicateFavoritesFound': 'No Duplicate Favorites Found',
      'confirmDeduplicateFavorites': 'Confirm Deduplicate Favorites',
      'confirmDeduplicateFavoritesContent': 'Found @duplicateCount duplicates (same category and normalized title). Keep the first, remove the rest?',
      'deduplicateFavoritesCompleted': 'Deduplicate completed: @successCount succeeded, @failedCount failed',
      'favoriteBatchOperationFailed': 'Favorite Batch Operation Failed',
...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'aiCenter': 'AI Center',
      'aiXpTab': 'XP Profile',
      'aiRecommendTab': 'Recommendations',
      'aiManageTab': 'Manage',
      'aiSearchTab': 'Search',
      'aiXpProfile': 'AI XP Profile',
      'refreshAiXp': 'Resync favorites and analyze',
      'aiXpEmpty': 'Configure the AI API, then sync favorites to generate a profile.',
      'aiXpSourceCount': 'Based on @count favorites',
      'aiXpUpdatedAt': 'Updated at @time',
      'aiProfileSummary': 'Profile summary',
      'aiPreferenceThemes': 'Preference themes',
      'aiRecommendedSearches': 'Suggested searches',
      'aiAdvancedStats': 'Evidence statistics',
      'aiFavoriteCacheStatus': 'Shared favorite cache: @count items, synced @time',
      'aiGeneratedRemotely': 'Generated by the configured remote AI',
      'aiEvidenceTags': 'Supporting tags',
      'aiConfigureApiAction': 'Configure API',
      'aiLocalStatsNotice': 'Local statistics only prepare evidence; the summary and decisions above come from remote AI.',
      'aiTopTags': 'Top Tags',
      'aiTitlePreferences': 'Title Preferences',
      'aiTagPairs': 'Tag Pairs',
      'aiSaturatedTags': 'Saturated Tags',
      'aiProfileBuilt': 'XP profile built',
      'aiRecommendations': 'AI Recommendations',
      'generateAiRecommendations': 'Generate Recommendations',
      'noAiRecommendations': 'No recommendations yet',
      'aiRecommendationScore': 'Score: @score',
      'aiRecommendationReasons': 'Reasons',
      'aiFavoriteOrganizer': 'Favorite Organizer',
      'organizationRequirement': 'Build an XP profile first to organize favorites',
      'previewOrganization': 'Preview Organization',
      'noOrganizationRules': 'No organization rules matched',
      'noOrganizationChanges': 'No changes needed',
      'organizationPreviewTitle': 'Organization Preview',
      'organizationMoveLabel': 'Move "@title" from @from to @to',
      'applySelectedMoves': 'Apply Selected Moves',
      'organizationApplied': 'Organization applied: @success succeeded, @failed failed',
      'scanAiDuplicates': 'Scan Duplicates',
      'duplicatePreviewTitle': 'Duplicate Preview',
      'duplicateGroupLabel': '@title (@count)',
      'duplicateKeeper': 'Keep',
      'duplicateRemove': 'Remove',
      'noAiDuplicates': 'No duplicates found',
      'duplicatesRemoved': 'Duplicates removed: @success succeeded, @failed failed',
      'enhancedAiSearch': 'Enhanced AI Search',
      'aiSearchRequirement': 'Build an XP profile first to use enhanced search',
      'runEnhancedSearch': 'Search',
      'aiSettings': 'AI Settings',
      'enableRemoteAi': 'Enable Remote AI',
      'aiEndpoint': 'API Endpoint',
      'aiModel': 'Model',
      'aiApiKey': 'API Key',
      'remoteAiDataNotice': 'Compact favorite statistics and candidate metadata may be sent to the configured endpoint',
      'aiSettingsSaved': 'AI settings saved',
      'aiNotConfigured': 'AI API is not configured',
      'localAiMode': 'Local statistics',
      'remoteAiMode': 'Remote AI',
      'aiLoadingFavorites': 'Loading favorites (@count)',
      'aiLoadingMetadata': 'Loading metadata (@current/@total)',
      'aiBuildingProfile': 'Building XP profile…',
      'aiFetchingCandidates': 'Fetching candidates (@current/@total)',
      'aiScoringCandidates': 'Scoring candidates…',
      'aiAnalyzingOrganization': 'Analyzing organization…',
      'aiApplyingOrganization': 'Applying organization (@current/@total)',
      'aiScanningDuplicates': 'Scanning duplicates…',
      'aiRemovingDuplicates': 'Removing duplicates (@current/@total)',
      'aiInterpretingSearch': 'Interpreting search…',
      'aiOperationFailed': 'AI operation failed',
      'aiNeedProfile': 'Please build an XP profile first',
      'aiSelectAtLeastOne': 'Select at least one item',
      'aiRemoteFallback': 'Remote AI request failed',
    };
  }
}
