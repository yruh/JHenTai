...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'refreshAiXp': 'Atualizar XP',
      'aiXpEmpty': 'Ainda sem perfil XP. Atualize para construir a partir dos favoritos.',
      ...
      'remoteAiDataNotice': 'A IA remota pode enviar dados de perfil e consulta ao endpoint configurado',
      'aiSettingsSaved': 'Configurações de IA salvas',
      'aiNotConfigured': 'IA remota não configurada',
      'localAiMode': 'IA local',
      ...
      'aiRemoteFallback': 'IA remota indisponível, voltou para o modo local',
    };
  }
}
