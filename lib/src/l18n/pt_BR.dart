...
class pt_BR {
  static Map<String, String> keys() {
    return {
      ...
      'onlyShowGalleriesWithoutTorrents': 'Mostrar apenas galerias sem torrents',
      'hideFavoritedGalleries': 'Ocultar galerias favoritas',
      'filterGalleriesByTorrentsFailed': 'Falha ao filtrar galerias por torrents',
      ...
      'favoriteBatchOperations': 'Operações em lote de favoritos',
      'batchFetchFavoriteTorrents': 'Buscar torrents dos favoritos em lote',
      'deduplicateFavorites': 'Remover favoritos duplicados',
      'loadingAllFavorites': 'Carregando todos os favoritos',
      'checkingFavoriteTorrents': 'Verificando torrents dos favoritos',
      'fetchingFavoriteTorrents': 'Buscando torrents dos favoritos',
      'noFavoriteTorrentsFound': 'Nenhum torrent de favorito encontrado',
      'favoriteTorrentsCopied': 'Copiados @torrentCount torrents de @galleryCount galerias, falhas: @failedCount',
      'favoriteTorrentsUnavailable': 'Nenhum torrent copiável obtido; @failedCount galerias falharam na verificação',
      'noDuplicateFavoritesFound': 'Nenhum favorito duplicado encontrado',
      'confirmDeduplicateFavorites': 'Confirmar remoção de favoritos duplicados',
      'confirmDeduplicateFavoritesContent': 'Encontrados @duplicateCount duplicados (mesma categoria e título normalizado). Manter o primeiro e remover os demais?',
      'deduplicateFavoritesCompleted': 'Remoção de duplicados concluída: @successCount com sucesso, @failedCount falharam',
      'favoriteBatchOperationFailed': 'Falha na operação em lote de favoritos',
...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'aiXpTab': 'Perfil XP',
      'aiRecommendTab': 'Recomendações',
      'aiManageTab': 'Gerenciar',
      'aiSearchTab': 'Pesquisa',
      'aiXpProfile': 'Perfil XP de IA',
      'refreshAiXp': 'Ressincronizar favoritos e analisar',
      'aiXpEmpty': 'Configure a API de IA e sincronize os favoritos para gerar um perfil.',
      'aiXpSourceCount': 'Com base em @count favoritos',
      'aiXpUpdatedAt': 'Atualizado em @time',
      'aiProfileSummary': 'Resumo do perfil',
      'aiPreferenceThemes': 'Temas de preferência',
      'aiRecommendedSearches': 'Pesquisas sugeridas',
      'aiAdvancedStats': 'Estatísticas de evidência',
      'aiFavoriteCacheStatus': 'Cache compartilhado: @count itens, sincronizado em @time',
      'aiGeneratedRemotely': 'Gerado pela IA remota configurada',
      'aiEvidenceTags': 'Tags de evidência',
      'aiConfigureApiAction': 'Configurar API',
      'aiLocalStatsNotice': 'As estatísticas locais apenas preparam evidências; o resumo e as decisões acima vêm da IA remota.',
      'aiTopTags': 'Tags principais',
      'aiTitlePreferences': 'Preferências de título',
      'aiTagPairs': 'Pares de tags',
      'aiSaturatedTags': 'Tags saturadas',
      'aiProfileBuilt': 'Perfil XP construído',
      'aiRecommendations': 'Recomendações de IA',
      'generateAiRecommendations': 'Gerar recomendações',
      'noAiRecommendations': 'Ainda sem recomendações',
      'aiRecommendationScore': 'Pontuação: @score',
      'aiRecommendationReasons': 'Motivos',
      'aiFavoriteOrganizer': 'Organizador de favoritos',
      'organizationRequirement': 'Construa um perfil XP primeiro para organizar os favoritos',
      'previewOrganization': 'Pré-visualizar organização',
      'noOrganizationRules': 'Nenhuma regra de organização correspondente',
      'noOrganizationChanges': 'Nenhuma alteração necessária',
      'organizationPreviewTitle': 'Pré-visualização da organização',
      'organizationMoveLabel': 'Mover "@title" de @from para @to',
      'applySelectedMoves': 'Aplicar movimentos selecionados',
      'organizationApplied': 'Organização aplicada: @success com sucesso, @failed falharam',
      'scanAiDuplicates': 'Escanear duplicados',
      'duplicatePreviewTitle': 'Pré-visualização de duplicados',
      'duplicateGroupLabel': '@title (@count)',
      'duplicateKeeper': 'Manter',
      'duplicateRemove': 'Remover',
      'noAiDuplicates': 'Nenhum duplicado encontrado',
      'duplicatesRemoved': 'Duplicados removidos: @success com sucesso, @failed falharam',
      'enhancedAiSearch': 'Pesquisa aprimorada por IA',
      'aiSearchRequirement': 'Construa um perfil XP primeiro para usar a pesquisa aprimorada',
      'runEnhancedSearch': 'Pesquisar',
      'aiSettings': 'Configurações de IA',
      'enableRemoteAi': 'Ativar IA remota',
      'aiEndpoint': 'Endpoint da API',
      'aiModel': 'Modelo',
      'aiApiKey': 'Chave da API',
      'remoteAiDataNotice': 'Estatísticas compactas dos favoritos e metadados dos candidatos podem ser enviados ao endpoint configurado',
      'aiSettingsSaved': 'Configurações de IA salvas',
      'aiNotConfigured': 'A API de IA não está configurada',
      'localAiMode': 'Estatísticas locais',
      'remoteAiMode': 'IA remota',
      'aiLoadingFavorites': 'Carregando favoritos (@count)',
      'aiLoadingMetadata': 'Carregando metadados (@current/@total)',
      'aiBuildingProfile': 'Construindo perfil XP…',
      'aiFetchingCandidates': 'Buscando candidatos (@current/@total)',
      'aiScoringCandidates': 'Pontuando candidatos…',
      'aiAnalyzingOrganization': 'Analisando organização…',
      'aiApplyingOrganization': 'Aplicando organização (@current/@total)',
      'aiScanningDuplicates': 'Escaneando duplicados…',
      'aiRemovingDuplicates': 'Removendo duplicados (@current/@total)',
      'aiInterpretingSearch': 'Interpretando pesquisa…',
      'aiOperationFailed': 'Operação de IA falhou',
      'aiNeedProfile': 'Construa um perfil XP primeiro',
      'aiSelectAtLeastOne': 'Selecione pelo menos um item',
      'aiRemoteFallback': 'Falha na solicitação à IA remota',
    };
  }
}
