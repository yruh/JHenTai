...
favnote：配對收藏備註
    ...
    ''',
      ...
      'aiManageTab': '管理',
      'aiSearchTab': '搜尋',
      'aiXpProfile': 'AI XP 畫像',
      'refreshAiXp': '重新同步收藏並分析',
      'aiXpEmpty': '請先設定 AI API，再同步收藏以產生畫像',
      'aiXpSourceCount': '基於 @count 個收藏',
      'aiXpUpdatedAt': '更新於 @time',
      'aiProfileSummary': '畫像摘要',
      'aiPreferenceThemes': '偏好主題',
      'aiRecommendedSearches': '建議搜尋方向',
      'aiAdvancedStats': '證據統計',
      'aiFavoriteCacheStatus': '共享收藏快取：@count 本，同步於 @time',
      'aiGeneratedRemotely': '由已設定的遠端 AI 產生',
      'aiEvidenceTags': '依據標籤',
      'aiConfigureApiAction': '設定 API',
      'aiLocalStatsNotice': '本機統計只負責整理證據；上方摘要與判斷均來自遠端 AI。',
      'aiTopTags': '熱門標籤',
      'aiTitlePreferences': '標題偏好',
      'aiTagPairs': '標籤組合',
      'aiSaturatedTags': '飽和標籤',
      'aiProfileBuilt': 'XP 畫像已建立',
      'aiRecommendations': 'AI 推薦',
      'generateAiRecommendations': '產生推薦',
      'noAiRecommendations': '尚無推薦',
      'aiRecommendationScore': '評分：@score',
      'aiRecommendationReasons': '推薦理由',
      'aiFavoriteOrganizer': '收藏整理',
      'organizationRequirement': '請先建立 XP 畫像後再整理收藏',
      'previewOrganization': '預覽整理',
      'noOrganizationRules': '沒有符合的整理規則',
      'noOrganizationChanges': '無需變更',
      'organizationPreviewTitle': '整理預覽',
      'organizationMoveLabel': '將「@title」從 @from 移至 @to',
      'applySelectedMoves': '套用所選移動',
      'organizationApplied': '整理完成：成功 @success 個，失敗 @failed 個',
      'scanAiDuplicates': '掃描重複',
      'duplicatePreviewTitle': '重複預覽',
      'duplicateGroupLabel': '@title（@count）',
      'duplicateKeeper': '保留',
      'duplicateRemove': '移除',
      'noAiDuplicates': '未發現重複',
      'duplicatesRemoved': '重複移除完成：成功 @success 個，失敗 @failed 個',
      'enhancedAiSearch': '增強 AI 搜尋',
      'aiSearchRequirement': '請先建立 XP 畫像後再使用增強搜尋',
      'runEnhancedSearch': '搜尋',
      'aiSettings': 'AI 設定',
      'enableRemoteAi': '啟用遠端 AI',
      'aiEndpoint': 'API 端點',
      'aiModel': '模型',
      'aiApiKey': 'API 金鑰',
      'remoteAiDataNotice': '收藏的精簡統計和候選漫畫中繼資料可能會傳送至所設定的端點',
      'aiSettingsSaved': 'AI 設定已儲存',
      'aiNotConfigured': 'AI API 尚未設定',
      'localAiMode': '本機統計',
      'remoteAiMode': '遠端 AI',
      'aiLoadingFavorites': '正在載入收藏（@count）',
      'aiLoadingMetadata': '正在載入中繼資料（@current/@total）',
      'aiBuildingProfile': '正在建立 XP 畫像…',
      'aiFetchingCandidates': '正在取得候選（@current/@total）',
      'aiScoringCandidates': '正在評分候選…',
      'aiAnalyzingOrganization': '正在分析整理方案…',
      'aiApplyingOrganization': '正在套用整理（@current/@total）',
      'aiScanningDuplicates': '正在掃描重複…',
      'aiRemovingDuplicates': '正在移除重複（@current/@total）',
      'aiInterpretingSearch': '正在解析搜尋…',
      'aiOperationFailed': 'AI 操作失敗',
      'aiNeedProfile': '請先建立 XP 畫像',
      'aiSelectAtLeastOne': '請至少選擇一項',
      'aiRemoteFallback': '遠端 AI 請求失敗',
    };
  }
}
